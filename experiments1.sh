...
python run_experiment.py --config-name=config1 --multirun hydra/launcher=joblib 'seed=range(64)' policy=OFULQ,TS,MED env_id=inverted_pendulum,boeing747,chained_integrator,large_transient,not_controllable,uav,unstable_laplacian
