...
if __name__ == '__main__':
    env = make_env("inverted_pendulum")
    controller = OFULQ(env, warmup_steps=50, improved_exploration_steps=0, learning_rate=1e-8)
    ...
    controller = MED(env, warmup_steps=50, improved_exploration_steps=0)
