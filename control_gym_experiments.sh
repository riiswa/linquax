#!/bin/bash
#SBATCH --job-name=linquax_control_dym         # Job name
...
python run_experiment.py --multirun hydra/launcher=joblib 'seed=range(32)' policy=OFULQ,TS,MED env_id=ac1,ac2,ac3,ac4,ac5,ac6,ac8,ac10,dis1,dis2,he1,he2,he3,psm
